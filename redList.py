...
for country in countryList:	
	...
	def speciesRichness(file, name):
		...
		for i in species:
			if i in redList['scientificName'].unique():
	...
	speciesRichness(amphibian_files, 'AmphibiansRL')
	speciesRichness(bird_files, 'BirdsRL')
	speciesRichness(mammal_files, 'MammalsRL')
	speciesRichness(reptile_files, 'ReptilesRL')
